    ...
    <section id="wsus__breadcrumb">
        <div class="wsus_breadcrumb_overlay">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h4>¡Bienvenido de nuevo! Tu tienda, tus detalles, tu cuenta.</h4>
                        ...
                        <ul class="nav nav-pills mb-3" id="pills-tab2" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-profile-tab2" data-bs-toggle="pill"
                                    ...
                                    aria-controls="pills-profiles" aria-selected="true">Crear cuenta</button>
                            </li>
                        </ul>
                                ...
                                <div class="wsus__login">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="wsus__login_save">
                                            ...
                                            <a class="forget_p" href="{{ route('password.request') }}">¿Has olvidado la contraseña?</a>
                                        </div>
                                ...
                                <div class="wsus__login">
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="wsus__login_input">
                                            ...
                                            <input id="email" name="email" value="{{old('email')}}" type="email" placeholder="Correo electrónico">
                                        </div>
                                        <div class="wsus__login_input">
                                            <i class="fas fa-key"></i>
