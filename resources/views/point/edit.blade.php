...
@section('title', 'Editar Puntos')

@section('content')
    <div class="container mx-auto p-6">
        <h1 class="text-2xl font-bold mb-4">{{ __('Editar Puntos') }}</h1>
        ...
        <form action="{{ route('point.update', $point->id) }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="date" name="load_date" id="load_date" value="{{ \Carbon\Carbon::parse($point->load_date)->format('Y-m-d') }}" required>
