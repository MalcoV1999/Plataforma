...
<section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="{{route('assistant.dashboard')}}">Dashboard</a></div>
      ...
      <div class="row mt-sm-4">
        <div class="col-12 col-md-12 col-lg-7">
          <div class="card" profile-widget>
            ...
            action="{{route('assistant.profile.update')}}" enctype="multipart/form-data">
                @csrf
        ...
        <div class="col-12 col-md-12 col-lg-7">
          <div class="card" profile-widget>
            ...
            <form method="post" class="needs-validation" novalidate="" 
            action="{{route('assistant.password.update')}}" enctype="multipart/form-data">
                @csrf
